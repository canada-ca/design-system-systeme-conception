          ...
          <li><a class="menu-drilldown" href="#intro">Introduction</a>
            ...
            <li><a class="menu-drilldown" href="#toc5">Writing principles for web content</a>
              <ul class="nav">
                ...
                <li class="longdoc-toc-link"><a href="#wp1-3">Provide equivalent content in both official languages</a></li>
              </ul>
            </li>
            ...
            <li><a class="menu-drilldown" href="#toc8">Style</a>
              <ul class="nav">
            ...
            <li><a class="menu-drilldown" href="#toc10">Images and videos</a>
              <ul class="nav">
...
<section>
 ...
 <ul>
  ...
  <li>added direction for linking to content available only on internal government networks (7.5)</li>
 </ul>
...
<section>
 ...
 <ul class="list-unstyled">
  <li id="q1">
   <details class="mrgn-bttm-sm" id="q1det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q1summ">In this section</summary>
    <ul>
     <li><a href="#wp1-1">Help people complete tasks</a></li>
     <li><a href="#wp1-2">Consider the needs of the audience</a>
      <ul>
       <li><a href="#wp1-2-1">Writing for accessibility</a></li>
       <li><a href="#wp1-2-2">Writing for readability</a></li>
       <li><a href="#wp1-2-3">Writing for specialist audiences</a></li>
       <li><a href="#wp1-2-4">Consider all screen sizes</a></li>
      </ul> </li>
     <li><a href="#wp1-3">Provide equivalent content in both official languages</a></li>
    </ul>
   </details> </li>
 </ul>
...
<section>
 ...
 <ul class="list-unstyled">
  <li id="q2">
   <details class="mrgn-bttm-sm" id="q2det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q2summ">In this section</summary>
    <ul>
     <li><a href="#wp2-1">Start with the most important information</a></li>
     <li><a href="#wp2-2">Use simple and common words</a></li>
     <li><a href="#wp2-3">Use active voice and positive form</a>
      <ul>
       <li><a href="#wp2-3-1">Active or passive voice</a></li>
       <li><a href="#wp2-3-2">Positive or negative form</a></li>
      </ul> </li>
     <li><a href="#wp2-4">Use verbs instead of nouns formed from verbs</a></li>
     <li><a href="#wp2-5">Avoid jargon, idioms and expressions</a></li>
     <li><a href="#wp2-6">Use simple sentences</a></li>
     <li><a href="#wp2-7">Use short sentences and paragraphs</a></li>
     <li><a href="#wp2-8">Explain references to legislation</a></li>
     <li><a href="#wp2-9">Check the reading level of the content</a>
      <ul>
...
<section>
 ...
 <ul class="list-unstyled">
  <li id="q3">
   <details class="mrgn-bttm-sm" id="q3det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q3summ">In this section</summary>
    <ul>
     <li><a href="#wp3-1">Write directly to the person</a>
      <ul>
     ...
     <li><a href="#wp3-2">Use "we" to refer to the Government of Canada</a>
      <ul>
       <li><a href="#wp3-2-1">Third parties</a></li>
      </ul> </li>
     <li><a href="#wp3-3">Expressing an obligation or a recommendation</a></li>
    </ul>
   </details> </li>
 </ul>
...
<section>
 ...
 <ul class="list-unstyled">
  <li id="q4">
   <details class="mrgn-bttm-sm" id="q4det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q4summ">In this section</summary>
    <ul>
     <li><a href="#wp4-1">Capitalization and punctuation</a>
      <ul>
     ...
     <li><a href="#wp4-2">Underlining, bold and italics</a></li>
     <li><a href="#wp4-3">Symbols</a></li>
     <li><a href="#wp4-4">Abbreviations and acronyms</a>
      <ul>
       <li><a href="#wp4-4-1">Latin abbreviations</a></li>
      </ul> </li>
     <li><a href="#wp4-5">Contractions</a></li>
     <li><a href="#wp4-6">Numbers</a></li>
     <li><a href="#wp4-7">Dates </a></li>
     <li><a href="#wp4-8">Times </a></li>
     <li><a href="#wp4-9">Phone numbers </a></li>
     <li><a href="#wp4-10">Mailing addresses </a></li>
     <li><a href="#wp4-11">Words and expressions in transition</a></li>
    </ul>
   </details> </li>
 </ul>
 ...
 <section>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp4-6" aria-label="See how the style rule for numbers applies to content in French">See how this rule applies to content in French</a></p>
...
<section>
 ...
 <ul class="list-unstyled">
  <li id="q5">
   <details class="mrgn-bttm-sm" id="q5det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q5summ">In this section</summary>
    <ul>
     <li><a href="#wp5-1">Write useful page titles and headings</a>
      <ul>
     ...
     <li><a href="#wp5-2">Use lists to help people scan </a>
      <ul>
     ...
     <li><a href="#wp5-3">Use tables to organize data</a>
      <ul>
 ...
 <section>
  ...
  <section>
   ...
   <div class="well panel">
    ...
    <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for writing useful page titles and headings on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp5-1" aria-label="Share the rule for writing useful page titles and headings by email">Share this rule by email</a></p>
   </div>
   <section class="alert alert-info">
 ...
 <section>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp5-3" aria-label="See how the rule for using tables to organize data applies to content in French">See how this rule applies to content in French</a></p>
   <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for using tables to organize data on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp5-3" aria-label="Share the rule for using tables to organize data by email">Share this rule by email</a></p>
  </div>
 </section>
</section>
<section>
 <h2 id="toc10">Images and videos</h2>
 <ul class="list-unstyled">
  <li id="q6">
   <details class="mrgn-bttm-sm" id="q6det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q6summ">In this section</summary>
    <ul>
     <li><a href="#wp6-1">Understand the purpose of images online</a>
      <ul>
     ...
     <li><a href="#wp6-2">Include alternative text for images</a></li>
     <li><a href="#wp6-3">Include long descriptions for complex images</a></li>
     <li><a href="#wp6-4">Include transcripts to describe audio and video files</a></li>
    </ul>
   </details> </li>
 </ul>
 ...
 <section class="alert alert-info">
  <h3 class="h4">Tip: obtain permission to publish</h3>
 ...
 <section>
  ...
  <section>
   ...
   <section>
    ...
    <figure class="mrgn-bttm-lg">
     ...
     <img alt="Map of Canada: current conditions" class="img-responsive center-block" src="https://www.canada.ca/content/dam/canada/tbs-sct/migration/hgw-cgf/oversight-surveillance/communications/images/csc-grc-fig-04-eng.JPG">
     <details>
      ...
      <table class="table table-bordered table-condensed">
       <thead>
        <tr class="active">
         ...
         <th scope="col"><strong>Condition</strong></th>
         <th scope="col"><strong>Temperature</strong></th>
        </tr>
       </thead>
       <tbody>
        <tr>
    ...
    <figure class="mrgn-bttm-lg">
     ...
     <img alt="Bar chart for number of pages by main purpose and audience" class="img-responsive center-block" src="https://www.canada.ca/content/dam/canada/tbs-sct/migration/hgw-cgf/oversight-surveillance/communications/images/csc-grc-fig-05-eng.JPG">
     <details>
  ...
  <section>
   ...
   <section>
    ...
    <p><img alt="A Royal Canadian Mounted Police officer on the Canada.ca web page related to jobs and the workplace." class="img-responsive center-block" src="https://www.canada.ca/content/dam/canada/tbs-sct/migration/hgw-cgf/oversight-surveillance/communications/images/csc-grc-fig-06-eng.JPG"></p>
  ...
  <section>
   ...
   <div class="well panel">
    <!--UPDATE LATER-->
    <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp6-1" aria-label="See how the rule for using images applies to content in French">See how this rule applies to content in French</a></p>
    <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for using images on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp6-1" aria-label="Share the rule for using images by email">Share this rule by email</a></p>
   </div>
  </section>
 </section>
 <section>
  ...
  <ul>
   ...
   <li>use the text that is embedded in the image only if it provides enough context; otherwise, write different text that includes more <a name="_Toc442715484"></a>information &nbsp;</li>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp6-2" aria-label="See how the rule for using images applies to content in French">See how this rule applies to content in French</a></p>
   <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for using images on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp6-2" aria-label="Share the rule for using images by email">Share this rule by email</a></p>
  </div>
 </section>
 <section>
  ...
  <section>
   ...
   <figure class="mrgn-bttm-lg">
    ...
    <img alt="A balanced scorecard showing how business activities align with an organization's vision and strategy to monitor key performance indicators. Text version below. " class="img-responsive center-block" src="https://www.canada.ca/content/dam/canada/tbs-sct/migration/hgw-cgf/oversight-surveillance/communications/images/csc-grc-fig-01b-eng.jpg">
    ...
    <p>Business activities are grouped into 4 perspectives, all of which are interdependent and come from the vision and strategy. These are learning and growth, internal business processes, financial, and customer. Each has a question associated with it.</p>
    <ul>
     <li>Learning and growth</li>
    </ul>
    <p>To achieve our vision, how will we sustain our ability to change and improve?</p>
    <ul>
     <li>Internal business processes</li>
    </ul>
    <p>To satisfy our shareholders and customers, what business processes must we excel at?</p>
    <ul>
     <li>Financial</li>
    </ul>
    <p>To succeed financially, how should we appear to our shareholders?</p>
    <ul>
     <li>Customer</li>
    </ul>
  ...
  <section>
   ...
   <figure class="mrgn-bttm-lg">
    ...
    <img alt="Comparison of the ratio of women and men in the civil service between 1983 and 2010. Text version below." class="img-responsive center-block" src="https://www.canada.ca/content/dam/canada/tbs-sct/migration/hgw-cgf/oversight-surveillance/communications/images/csc-grc-fig-02b-eng.jpg">
    <p>Source: Office of the Chief Human Resources Officer, Treasury Board of Canada Secretariat <br> Note: Includes all tenures. Figures do not include employees on leave without pay.</p>
    <h5>Alternative text</h5>
    <p>You could write the following alternative text:</p>
    <p>Comparison of the ratio of women and men in the civil service between 1983 and 2010. Text version below.</p>
    <h5>Long description</h5>
    <p>You could write the following long description text:</p>
    <table class="table table-bordered table-condensed">
     <caption>
      <strong>Figure 2: proportion of men and women in the public service for selected years 1983 to 2010</strong>
     </caption>
     <thead>
      <tr class="active">
       <th scope="col"><strong>Gender (by percentage)</strong></th>
       <th scope="col"><strong>1983</strong></th>
       <th scope="col"><strong>1988</strong></th>
       <th scope="col"><strong>1993</strong></th>
       <th scope="col"><strong>1998</strong></th>
       <th scope="col"><strong>2003</strong></th>
       <th scope="col"><strong>2008</strong></th>
       <th scope="col"><strong>2010</strong></th>
      </tr>
     </thead>
     <tfoot>
      <tr>
       <td class="small" colspan="8"><p>Source: Office of the Chief Human Resources Officer, Treasury Board of Canada Secretariat<br> Note: Includes all tenures. Figures do not include employees on leave without pay.</p></td>
      </tr>
     </tfoot>
     <tbody>
      <tr>
       ...
       <td class="text-right nowrap">49.6</td>
       <td class="text-right nowrap">46.7</td>
       <td class="text-right nowrap">45.1</td>
      ...
      <tr>
       ...
       <td class="text-right nowrap">50.4</td>
       <td class="text-right nowrap">53.3</td>
       <td class="text-right nowrap">54.9</td>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp6-3" aria-label="See how the rule for long descriptions applies to content in French">See how this rule applies to content in French</a></p>
   <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for including a long description for complex images on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp6-3" aria-label="Share the rule for long descriptions by email">Share this rule by email</a></p>
  </div>
 </section>
 <section>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp6-4" aria-label="See how the rule for transcripts applies to content in French">See how this rule applies to content in French</a></p>
   <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for including a transcript that describes audio and videos files on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp6-4" aria-label="Share the rule for transcripts by email">Share this rule by email</a></p>
  </div>
 </section>
</section>
<section>
 <h2 id="toc11">Links</h2>
 <ul class="list-unstyled">
  <li id="q7">
   <details class="mrgn-bttm-sm" id="q7det">
    <summary class="wb-toggle h4" data-toggle="{&quot;print&quot;:&quot;on&quot;}" id="q7summ">In this section</summary>
    <ul>
     <li><a href="#wp7-1">Use links strategically</a>
      <ul>
       <li><a href="#wp7-1-1">Carefully select related content</a></li>
      </ul> </li>
     <li><a href="#wp7-2">Write descriptive links</a>
      <ul>
       <li><a href="#wp7-2-1">Focus on the task</a></li>
      </ul> </li>
     <li><a href="#wp7-3">Make sure that links work</a></li>
     <li><a href="#wp7-4">Linking to non-government content </a></li>
    </ul>
   </details> </li>
 </ul>
 ...
 <section>
  ...
  <ul>
   ...
   <li>link to the original information posted by the authoritative source </li>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp7-1" aria-label="See how the rule for using links strategically applies to content in French">See how this rule applies to content in French</a></p>
   <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for using links strategically on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp7-1" aria-label="Share the rule for using links strategically by email">Share this rule by email</a></p>
  </div>
 </section>
 <section>
  ...
  <section>
   ...
   <div class="well panel">
    <!--UPDATE LATER-->
    <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp7-2" aria-label="See how the rule for writing descriptive links applies to content in French">See how this rule applies to content in French</a></p>
    <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for writing descriptive links on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp7-2" aria-label="Share the rule for writing descriptive links by email">Share this rule by email</a></p>
   </div>
  </section>
 </section>
 <section>
  ...
  <div class="well panel">
   <!--UPDATE LATER-->
   <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp7-3" aria-label="See how the rule for verifying links applies to content in French">See how this rule applies to content in French</a></p>
   <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for making sure links work as expected on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp7-3" aria-label="Share the rule for verifying links by email">Share this rule by email</a></p>
  </div>
 </section>
 <section>
  ...
  <section>
   ...
   <div class="well panel">
    <!--UPDATE LATER-->
    <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp7-4" aria-label="See how the rule for non-government content applies to content in French">See how this rule applies to content in French</a></p>
    <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for including links to unilingual non-government content on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp7-4" aria-label="Share the rule for non-government content by email">Share this rule by email</a></p>
   </div>
  </section>
 </section>
</section>
<section>
 ...
 <div class="well panel">
  <!--UPDATE LATER-->
  <p><a href="/fr/secretariat-conseil-tresor/services/communications-gouvernementales/guide-redaction-contenu-canada.html#wp7-5" aria-label="See how the rule for non-government content applies to content in French">See how this rule applies to content in French</a></p>
  <p><a href="mailto:?subject=Canada.ca Content Style Guide&amp;body=See the rule for including links to internal-to-government content on Canada.ca: https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/canada-content-style-guide.html#wp7-5" aria-label="Share the rule for internal-to-government content by email">Share this rule by email</a></p>
 </div>
</section>
<section>
...
<section>
 ...
 <p><cite><a href="https://www.canadapost.ca/tools/pg/manual/PGaddress-e.asp">Addressing Guidelines</a></cite>, Canada Post<br> <a href="http://www.omafra.gov.on.ca/english/rural/facts/07-049.htm">Clear Writing</a>, Ministry of Agriculture, Food and Rural Affairs of Ontario<br> <cite><a href="http://www.publications.gc.ca/site/eng/413603/publication.html">Communicating with Seniors: Advice, Techniques and Tips</a></cite>, Health Canada <br> <a href="http://dyslexiahelp.umich.edu/sites/default/files/good_fonts_for_dyslexia_study.pdf">Good Fonts for Dyslexia</a>, Luz Rello, NLP &amp; Web Research Groups, et Ricardo Baeza-Yates, Yahoo! Labs &amp; Web Research Group, UPF<br> <a href="https://www.nngroup.com/articles/how-users-read-on-the-web/">How Users Read on the Web, Nielsen Norman Group</a><br> <cite><a href="http://ccat-ctac.org/CMFiles/Publication/CCAT-EN-new2.pdf">Introduction to Administrative Justice and To Plain Language</a></cite> (PDF), Council of Canadian Administrative Tribunals<br> <a href="https://www.gov.uk/guidance/content-design/what-is-content-design">Introduction to content design</a>, Government Digital Service, GOV.UK<br> <a href="http://www.noslangues-ourlanguages.gc.ca/index-eng.php">Language Portal of Canada</a>, Government of Canada<br> <cite><a href="http://www.ccat-ctac.org/CMFiles/Publication/Literacyandjustice.pdf">Literacy and Access to Administrative Justice in Canada</a></cite> (PDF), Council of Canadian Administrative Tribunals<br> <a href="http://abclifeliteracy.ca/workplace-literacy-facts">Literacy and Numeracy in Canada</a>, ABC Life Literacy Canada<br> <a href="https://www.nngroup.com/articles/writing-for-lower-literacy-users/">Lower-Literacy Users: Writing for a Broad Consumer Audience</a>, Jakob Nielsen, Nielsen Norman Group<br> <a href="https://www.nngroup.com/articles/minimize-cognitive-load/">Minimize Cognitive Load to Maximize Usability</a>, Kathryn Whitenton, Nielsen Norman Group<br> <a href="https://www.nngroup.com/articles/mobile-ux/">Mobile User Experience: Limitations and Strengths</a>, Raluca Budio, Nielsen Norman Group<br> <a href="http://grammar.about.com/od/mo/g/Negative-Contraction.htm">Negative contraction</a>, Richard Nordquist<br> <cite><a href="http://publications.gc.ca/site/eng/9.644871/publication.html">Plain Language Clear and Simple</a></cite>, Public Works and Government Services Canada (reprinted 2003)<br> <a href="http://plainlanguagenetwork.org/">Plain Language Association International</a><br> <a href="https://www.navigatormm.com/blog/plain-language-please-heres-why-to-avoid-marketese-online/">Plain Language, Please! Here's Why to Avoid "Marketese" Only</a>, Sarah Bauer<br> <cite><a href="http://www.publications.gc.ca/site/eng/9.695565/publication.html">Reaching Out: A Guide to Communicating With Aboriginal Seniors</a></cite>, Health Canada <br> <a href="http://www.noslangues-ourlanguages.gc.ca/index-eng.php">Resources of the Language Portal of Canada</a>, Government of Canada<br> <cite><a href="http://www.statcan.gc.ca/pub/89-555-x/89-555-x2013001-eng.htm">Skills in Canada: First Results from the Programme for the International Assessment of Adult Competencies</a></cite>, Statistics Canada<br> <a href="http://www.statcan.gc.ca/daily-quotidien/160518/dq160518b-eng.htm">Study: Literacy and numeracy among off-reserve First Nations people and Métis</a>, 2012, Statistics Canada<br> <a href="http://www.statcan.gc.ca/daily-quotidien/141104/dq141104b-eng.htm">Study: University graduates with lower levels of literacy and numeracy skills</a>, 2012, Statistics Canada<br> <a href="http://www.btb.termiumplus.gc.ca/tpv2alpha/alpha-fra.html?lang=fra&amp;index=frt">TERMIUM Plus</a>®, Translation Bureau<br> <cite><a href="http://www.btb.termiumplus.gc.ca/tpv2guides/guides/tcdnstyl/index-eng.html?lang=eng">The Canadian Style</a></cite>, Translation Bureau <br> <a href="http://www.musanim.com/miller1956/">The Magical Number Seven, Plus or Minus Two: Some Limits on Our Capacity for Processing</a>, George A. Miller<br> <a href="https://gathercontent.com/blog/use-pair-writing-to-collaborate-with-subject-matter-experts">Use pair writing to collaborate with subject matter experts</a>, Jonathan Kahn, GatherContent<br> <a href="http://www.searchenginepeople.com/blog/watch-your-punctuation-online.html">Watch Your Punctuation Online</a>, Search Engine People<br> <cite><a href="http://www.w3.org/TR/WCAG/">Web Content Accessibility Guidelines (WCAG) 2.0</a></cite>, World Wide Web Consortium (W3C)<br> <a href="http://www.deque.com/blog/dont-screen-readers-read-whats-screen-part-1-punctuation-typographic-symbols/">Why Don't Screen Readers Always Read What's on the Screen?</a>, The Deque Blog<br> <a href="https://www.nngroup.com/topic/writing-web/">Writing for the web</a>, Nielsen Norman Group<br> <cite><a href="https://www.uottawa.ca/uoweb/en/web-standards/web-writing">Writing for the Web: Principles and Guidelines</a></cite>, University of Ottawa</p>
    ...
    <div class="clearfix"></div>
    	<div class="row pagedetails">
    		...
    		<div class="datemod col-xs-12 mrgn-tp-lg">
    				<dl id="wb-dtmd">
    		<dt>Date modified:</dt>
    		<dd><time property="dateModified">July 23, 2018</time></dd>
    	</dl>
    		</div>
