# Contributor Covenant Code of Conduct for the `GC design system` project

([Français](#Code-de-conduite-pour-le-projet-système-de-conception-du-GC))

Contributors to repositories hosted in [`Canada-ca`](https://github.com/canada-ca/) are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
Les contributeurs aux dépôts hébergés dans [`Canada-ca`](https://github.com/canada-ca/) sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
